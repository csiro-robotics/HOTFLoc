...
class RelayTokenLocalGeometricConsistencyReranker(torch.nn.Module):
    ...
    Args:
        ...
        separate_batch_by_num_rt (bool): Process batch in sub-batches, grouped by number of relay tokens.
            Prevents point clouds with few relay tokens reducing the num correspondences of denser point clouds.
    """
    ...
    def __init__(
        ...
        self.sort_eigvec = sort_eigvec
        self.mutual = mutual
        self.separate_batch_by_num_rt = separate_batch_by_num_rt
...
def compute_rt_sgv_mask(
    ...
    Optionally allows masking out RT windows that have fewer points than a
