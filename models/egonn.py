"""
EgoNN code, unified into one module  
...
from dataset.quantization import Quantizer
...
class MinkGL(nn.Module):
    def __init__(self, trunk: MinkTrunk,
        ...
        self.global_pooling = PoolingWrapper(pool_method=self.global_pool_method,
    ...
    def forward(self, batch: Dict[str, torch.tensor], disable_global_head: bool = False,
                disable_local_head: bool = False, **kwargs):
