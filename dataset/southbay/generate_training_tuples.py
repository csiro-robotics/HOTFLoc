# Generate training triplets for Apollo Southbay
# Adapted from https://github.com/jac99/Egonn/blob/main/datasets/southbay/generate_training_tuples.py
...
def generate_triplets(ds: SouthBayDataset, map_split: str, query_split: str,
    ...
    for triplet in triplets:
        ...
        tuple = TrainingTuple(id=new_anchor_ndx, timestamp=pc.timestamp,
                              ...
                              position=pc_pos, pose=pc.pose, positives_poses=None)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default=None, help='Path to save training tuples')
    ...
    if args.save_dir is not None:
        ...
        pickle_filepath = os.path.join(args.save_dir, pickle_name)
    else:
