...
from dataset.pointnetvlad.generate_test_sets import P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, check_in_test_set
from dataset.pointnetvlad.generate_training_tuples_baseline import construct_query_dict
