"""Optional dependency management, adapted from OpenPlaceRecognition
(https://github.com/OPR-Project/OpenPlaceRecognition).
...
class OptionalDependencyManager:
    ...
    @classmethod
    @lru_cache(maxsize=None)
    def is_available(cls, package: str, min_version: Optional[str] = None) -> bool:
        ...
        try:
            ...
            print(f"Could not parse version for {package}")
            return True
...
def lazy(package: str, *, feature: str, min_version: Optional[str] = None) -> object:
